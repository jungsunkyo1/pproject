...
pluralCaseList.push( {plural: "taxiRequests", pascal: "TaxiRequest"} )

pluralCaseList.push( {plural: "requestStatuses", pascal: "RequestStatus"} )
pluralCaseList.push( {plural: "reciepts", pascal: "Reciept"} )

pluralCaseList.push( {plural: "receiptInfos", pascal: "ReceiptInfo"} )
pluralCaseList.push( {plural: "payments", pascal: "Payment"} )


pluralCaseList.push( {plural: "requestAndReceiptInfos", pascal: "RequestAndReceiptInfo"} )
